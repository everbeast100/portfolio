...
const selectedTheme = localStorage.getItem('seleted-theme')
...
if(selectedTheme){
  //if the validation is fulfilled, we ask what the issues was to know if we activated or deactivated the dark theme
